...
$.Window = (function()  {
	...
	// static constants
	var VERSION = "5.02";           // the version of current plugin
	...
	function constructor(caller, options) {
		...
		function initialize(instance) {
			...
			var headerHtml = "<div class='window_header window_header_normal ui-widget-header "+cornerClass+"no-resizable "+options.headerClass+"'>"+
				"<img class='window_title_icon' src='"+options.icon+"' style='display:none;' onload='javascript:$.Window._iconOnLoad(this);'/>"+
		...
		function setIcon(iconUrl) {
			...
			// hide icon and set image soruce url
			hideIcon();
